...
| **UI Framework** | Tailwind CSS (local Vite/PostCSS build) + CSS Variable Theme System | Switchable built-in themes and custom JSON theme sync; production does not depend on the Tailwind CDN |
